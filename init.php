...
if ($con == false) {
    $error['db_error'] = 'Ошибка подключения: ' . mysqli_connect_error();
    $page_content = include_template('error.php', ['error' => $error['db_error']]);
    ...
    $result['db_connected'] = 'Соединение установлено';
}