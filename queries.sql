...
('1', '2', '0', '2017-12-03 17:45:01', 'DC Ply Mens 2016/2017 Snowboard', 'Два сезона откатал, немного покоцаный. Норм борд!', 'img/lot-2.jpg', '159999', '2017-12-06 17:45:01','1000'),
...
('3', '0', '2', '2017-12-03 17:47:01', 'Ботинки для сноуборда DC Mutiny Charocal', 'Боты круть, и совсем не пахнут.', 'img/lot-4.jpg','10999', '2018-01-03 17:47:01','400'),
('4', '1', '3', '2017-12-03 17:48:01', 'Куртка для сноуборда DC Mutiny Charocal', 'Курточка моя так хорошo сидит на мне).', 'img/lot-5.jpg','7500', '2018-01-03 17:48:01','200'),
...
SELECT lot_name, description, c.category
FROM lot
JOIN categories c
ON category_id=c.id
WHERE lot_name='Куртка для сноуборда DC Mutiny Charocal' OR description LIKE '%борд%';

UPDATE lot SET lot_name='Маска Oakley Canopy' WHERE id = '5';

SELECT l.lot_name, b.bet_value, c.category
FROM lot l
JOIN bet b
ON l.id=b.lot_id
JOIN categories c
