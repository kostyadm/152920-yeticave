        ...
        <div class="lot-item__left">
            <div class="lot-item__image">
                <img src="<?= isset($jpg['path']) ? "img/uploads/" . $jpg['path'] : $details['pic-link'] ?>" width="730"
                     height="548"
                     alt="<?= isset($post_data['category']) ? $post_data['category'] : $details['category']; ?>">
            </div>
            <p class="lot-item__category">Категория:
                <span><?= isset($post_data['category']) ? $post_data['category'] : $details['category'] ?></span></p>
            ...
            <div class="lot-item__state">
                ...
                <div class="lot-item__cost-state">
                    ...
                    <div class="lot-item__min-cost">
                        Мин. ставка
                        <span><?= isset($post_data['lot-rate']) ? $post_data['lot-rate'] + $post_data['lot-step'] : '12 000 р'; ?></span>
                    </div>
                </div>
                <form class="lot-item__form" action="https://echo.htmlacademy.ru" method="post">
                    <p class="lot-item__form-item">
                        ...
                        <input id="cost" type="number" name="cost"
                               placeholder="<?= isset($post_data['lot-rate']) ? $post_data['lot-rate'] + $post_data['lot-step'] : '12 000 р'; ?>">
                    </p>
